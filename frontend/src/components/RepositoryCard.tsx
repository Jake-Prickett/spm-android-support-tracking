        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-base font-semibold truncate mb-2">
            ...
            <div className="flex items-center gap-4 text-xs flex-wrap" style={{ color: 'var(--text-tertiary)' }}>
              <span className="flex items-center gap-1" title={`${repository.stars?.toLocaleString() || '0'} stars`}>
              ...
              <span className="flex items-center gap-1" title={`${repository.forks?.toLocaleString() || '0'} forks`}>
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
